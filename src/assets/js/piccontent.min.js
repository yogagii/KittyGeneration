$(function() {
	...
	var firstsrc = firstpic.attr("src");
	...
	function nextclick() {
		...
		if (currrentindex != (length - 1)) {
			...
			var curnextsrc = curnextli.find("img").attr("src");
	...
	getli.click(function() {
		...
		var bigimgsrc = currentli.find("img").attr("src");
	...
	$(".replaybtn2").click(function() {
		...
		var bigimgsrc = $(".detail_picbot_mid ul li").eq(0).find("img").attr("src");
		$("#pic1").attr("src", bigimgsrc);
